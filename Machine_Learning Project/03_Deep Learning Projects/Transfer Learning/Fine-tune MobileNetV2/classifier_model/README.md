...
The main aim is to build a robust image classification model capable of identifying images.
...
# Features
*Predicts images using a Lightweight Models
...
cd Machine_learning-Projects/Machine_Learning_Project/03_Deep Learning Projects/Transfer Learning/Fine-tune MobileNetV2/classifier_model
