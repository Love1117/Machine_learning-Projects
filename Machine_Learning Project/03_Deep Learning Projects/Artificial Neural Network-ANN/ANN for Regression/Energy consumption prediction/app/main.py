...
class EnergyAdmin(ModelView, model=Prediction):
    column_list = [
        Prediction.id,
        Prediction.Home_ID,
        Prediction.Outdoor_Temperature_C,
        ...
        Prediction.Hour,
        Prediction.Weekend,
        Prediction.Appliance_Type_status,
        Prediction.Season_status,
        Prediction.Energy_Consumption_kWh,
    ]
