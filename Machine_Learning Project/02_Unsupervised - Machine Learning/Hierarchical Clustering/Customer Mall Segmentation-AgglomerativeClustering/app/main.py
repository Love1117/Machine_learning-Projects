...
app = FastAPI(
    title="Customer Mall Segmentation API",
...
class CustomerMallAdmin(ModelView, model=Prediction):
    column_list = [
        Prediction.id,
        Prediction.Gender,
        Prediction.Age,
        Prediction.Annual_Income_k,
        Prediction.Spending_Score_1_100,
...
admin.add_view(CustomerMallAdmin)
