...
app = FastAPI(
    title="Customer Spending Habit(segmentation) API",
...
class SpendingAdmin(ModelView, model=Prediction):
    column_list = [
        Prediction.id,
        Prediction.Gender,
        Prediction.Ever_Married,
        Prediction.Age,
        Prediction.Graduated,
        Prediction.Work_Experience,
        Prediction.Spending_Score,
        Prediction.Family_Size,
        Prediction.Profession_status,
        Prediction.Variable_status,
